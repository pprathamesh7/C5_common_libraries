...
setup(
  ...
  license='osl-3.0',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository
  ...
  download_url = 'https://github.com/pprathamesh7/C5_common_libraries/archive/refs/tags/v_01.tar.gz',    # I explain this later on
  ...
  classifiers=[
    ...
    'License :: OSI Approved :: osl-3.0 License',   # Again, pick a license  
